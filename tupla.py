...
# print(resposta)
# tupla[(275.0, 35.0, 50.0)]  quando retorna mais de um valor dentro de parentes e são imutaveis (não podem ser editados)
...
# cada venda o vendedor ganha R$2 e 1% da venda
